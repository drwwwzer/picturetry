...
bool doorlock_sniper__msg__video_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doorlock_sniper.msg._video_packet.VideoPacket", full_classname_dest, 45) == 0);
  }
  doorlock_sniper__msg__VideoPacket * ros_message = _ros_message;
  {  // sequence_id
...
{
  /* NOTE(esteve): Call constructor of VideoPacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doorlock_sniper.msg._video_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VideoPacket");
  ...
  {  // data
    ...
    memcpy(dst, src, 150 * sizeof(uint8_t));
    Py_DECREF(field);
  }
