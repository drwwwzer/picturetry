...
static const _VideoPacket_type_support_symbol_names_t _VideoPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doorlock_sniper, msg, VideoPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doorlock_sniper, msg, VideoPacket)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doorlock_sniper, msg, VideoPacket)() {
  return &::doorlock_sniper::msg::rosidl_typesupport_c::VideoPacket_message_type_support_handle;
}
