...
local_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                    ...
                    {'name': 'pointcloud.stream_filter',     'default': '2', 'description': 'pointcloud with infrared'},
                   ]
# 0 - RS2_STREAM_ANY (任意流)
# 1 - RS2_STREAM_DEPTH (深度流)
# 2 - RS2_STREAM_COLOR (彩色流) - 默认值，使用RGB颜色为点云着色
# 3 - RS2_STREAM_INFRARED (红外流) - 使用红外图像为点云着色
# 4 - RS2_STREAM_FISHEYE (鱼眼流)
# 5 - RS2_STREAM_GYRO (陀螺仪流)
# 6 - RS2_STREAM_ACCEL (加速度计流)
